...
const player = new Fighter({
  ...
  const enemy = new Fighter({
    ...
    sprites: {
      ...
      run: {
        imageSrc: './Assets/King/Run.png',
        framesMax: 8
      },
      jump: {
        imageSrc: './Assets/King/Jump.png',
        framesMax: 2
      },
      fall: {
        imageSrc: './Assets/King/Fall.png',
        framesMax: 2
      },
      attack1: {
        imageSrc: './Assets/King/Attack1.png',
        framesMax: 4
      },
      takeHit: {
        imageSrc: './Assets/King/Take hit.png',
        framesMax: 4
      },
      death: {
        imageSrc: './Assets/King/Death.png',
        framesMax: 6
      }
    },
    attackBox: {
